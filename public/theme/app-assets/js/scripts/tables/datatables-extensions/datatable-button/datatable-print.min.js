    ...
    $(".dataex-visibility-print").DataTable({
        ...
        buttons: [{
            ...
            customize: function (t) {
                $(t.document.body).css("font-size", "10pt").prepend('<img src="http://datatables.net/media/images/logo-fade.png" style="position:absolute; top:0; left:0;" />'), $(t.document.body).find("table").addClass("compact").css("font-size", "inherit")
            }
        }]
    })
}));
