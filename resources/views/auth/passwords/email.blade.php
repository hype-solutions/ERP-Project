  ...
  <div class="col-12 d-flex align-items-center justify-content-center">
    <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
      <div class="card border-grey border-lighten-3 m-0">
        ...
        @endif
            <form method="POST" class="form-horizontal form-simple" action="{{ route('password.email') }}">
              @csrf
              <fieldset class="form-group position-relative has-icon-left mb-0">
                <input type="text"  name="email" class="form-control" id="user-name" placeholder="البريد الإلكتروني" value="{{ old('email') }}" required autofocus>
                <div class="form-control-position">
                  <i class="la la-user"></i>
                </div>
              </fieldset>

              <button type="submit" class="btn btn-success btn-block"><i class="ft-unlock"></i> أرسل رابط تغيير كلمة المرور</button>
            </form>
          </div>
        </div>
      </div>
