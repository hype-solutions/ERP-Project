            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                            ...
                            <li class="col-md-5 px-2">
                                ...
                                <ul class="row mt-2">
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3"
                                            href="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/rtl/ecommerce-menu-template"
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#"
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0"><span class="grey darken-2">التحكم</span></h6><span
                                    class="notification-tag badge badge-warning float-right m-0">-</span>
                            </li>
                            <li class="scrollable-container media-list w-100"><a target="_blank"
                                ...
                                </a><a target="_blank" href="https://mail.google.com/">
                                    <div class="media">
                                        <div class="media-left"><span
