                        ...
                        <div class="btn-group mr-1 mb-1">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                @if ($safe->branch_id == 0)
                                    ...
                                    <form action="{{ route('safes.delete', $safe->id) }}" method="post"
                                        onsubmit="return confirm('هل أنت متأكد من حذف هذا الخزنة نهائيا و جميع تفاصيله من البرنامج')">
                                        @csrf
                                        @method('delete')
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            @if ($safe->branch_id > 0)
                                                <tr>
                                                    <td>الفرع المربوط:</td>
                                                    <td><a href="{{ route('branches.view', $safe->branch_id) }}"
                                                            target="_blank">{{ $safe->branch->branch_name }}</a></td>
                                                </tr>
                                            @endif
                                ...
                                <div class="col-xl-6 col-lg-12 mb-1">
                                    <div class="form-group text-center">
                                        ...
                                        <button type="button" class="btn btn-float btn-float-lg btn-outline-pink"><i
                                                class="">{{ $safe->safe_balance }} ج.م</i><span>رصيد
                                                الخزنة</span></button>
                                    ...
                                    <ul class="nav nav-tabs nav-top-border no-hover-bg mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="active-tab32" data-toggle="tab" href="#active32"
                                                aria-controls="active32" aria-expanded="true">العمليات</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="link-tab32" data-toggle="tab" href="#link32"
                                                aria-controls="link32" aria-expanded="false">التحويلات</a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="badge border-info info badge-border">
                                                                        <a href="#" target="_blank"
                                                                            style="color: #1e9ff2"><span>{{ $transaction->id }}</span></a>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-success"
                                                                        onclick="return pay('{{ route('safes.receipt', $transaction->id) }}');">استعراض</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if ($transfer->authUser)
                                                                        الرصيد قبل:
                                                                        {{ $transfer->amount_before_transfer_from }} ج.م
                                                                        <br>
                                                                        الرصيد بعد:
                                                                        {{ $transfer->amount_after_transfer_from }} ج.م
                                                                    @else
                                                                        @if (isset($transfer->safeFrom))
                                                                            الرصيد قبل: {{ $transfer->safeFrom->safe_balance }}
                                                                            ج.م
                                                                            <br>
                                                                            الرصيد بعد:
                                                                            {{ $transfer->safeFrom->safe_balance - $transfer->transfer_amount }}
                                                                            ج.م
                                                                        @else
                                                                        الرصيد قبل:
                                                                        {{ $transfer->amount_before_transfer_from }} ج.م
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if ($transfer->authUser)
                                                                        ...
                                                                        الرصيد قبل:
                                                                        {{ $transfer->amount_before_transfer_to }} ج.م
                                                                        <br>
                                                                        الرصيد بعد:
                                                                        {{ $transfer->amount_after_transfer_to }} ج.م
                                                                    @else
                                                                        @if (isset($transfer->safeTo))
                                                                            الرصيد قبل: {{ $transfer->safeTo->safe_balance }}
                                                                            ج.م
                                                                            <br>
                                                                            الرصيد بعد:
                                                                            {{ $transfer->safeTo->safe_balance + $transfer->transfer_amount }}
                                                                            ج.م
                                                                        @else
                                                                        الرصيد قبل:
                                                                        {{ $transfer->amount_before_transfer_to }} ج.م
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                        <small class="danger">لم يتم التصديق عليها
                                                                            بعد</small>
                                                                    @endif
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-success"
                                                                        onclick="return pay('{{ route('safes.transferReceipt', $transfer->id) }}');">استعراض</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
