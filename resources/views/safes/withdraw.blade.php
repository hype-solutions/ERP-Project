...
@endif
    ...
    @if(session()->get('success') == 'withdrawed' )
<div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
    <span class="alert-icon"><i class="la la-thumbs-o-up"></i></span>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">×</span>
    </button>
    <strong>تم بنجاح!</strong> تسجيل عملية سحب
</div>
    @endif
@endif
    ...
    <div class="col-12 col-sm-7">
        <div class="row breadcrumbs-top">
            ...
            <li class="breadcrumb-item"><a href="{{route('safes.list')}}">الخزن</a></li>
                <li class="breadcrumb-item active">سحب
                </li>
              </ol>
            </div>
          </div>
  ...
  <div class="card">
    <div class="card-content">
        ...
        <form class="form" method="post" action="{{route('safes.withdrawing')}}">
                @csrf
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label for="projectinput8">تفاصيل السحب</label>
                        <div class="position-relative has-icon-left">
