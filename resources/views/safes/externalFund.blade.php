@extends('layouts.erp')
@section('title', 'تمويل خارجي في خزنه '.$safe->safe_name)
...
@endif
    ...
    @if(session()->get('success') == 'funded' )
<div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
    <span class="alert-icon"><i class="la la-thumbs-o-up"></i></span>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">×</span>
    </button>
    <strong>تم بنجاح!</strong> تسجيل عملية تمويل خارجي
</div>
    @endif
@endif
    ...
    <div class="col-12 col-sm-7">
        <div class="row breadcrumbs-top">
            ...
            <li class="breadcrumb-item"><a href="{{route('safes.list')}}">الخزن</a></li>
                <li class="breadcrumb-item active">تمويل خارجي
                </li>
              </ol>
            </div>
          </div>
  ...
  <div class="card">
    <div class="card-content">
        ...
        <form class="form" method="post" action="{{route('safes.externalFunding')}}">
                @csrf
                <input type="hidden" name="safe_id" value="{{$safe->id}}" />
                <div class="form-body">
                    <h4 class="form-section"><i class="ft-user"></i> عملية تمويل خارجي في خزنه {{$safe->safe_name}}</h4>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="timesheetinput2">الممول</label>
                                <span style="color:red">*</span>
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput2" class="form-control" name="investor" required>
                                    <div class="form-control-position">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="timesheetinput2">تاريخ التسديد للممول</label>
                                <span style="color:red">*</span>
                                <div class="position-relative has-icon-left">
                                    <input type="date" id="timesheetinput2" class="form-control"  name="refund_date" required>
                                    <div class="form-control-position">
                                     </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="projectinput8">تفاصيل التمويل خارجي</label>
                        <div class="position-relative has-icon-left">
