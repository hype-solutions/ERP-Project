...
<div class="alert alert-icon-left alert-success alert-dismissible mb-2" role="alert">
    ...
    <strong>تم بنجاح!</strong> تعديل ملف مستخدم
</div>
    @endif
@endif
    ...
    <div class="col-12 col-sm-7">
        <div class="row breadcrumbs-top">
            ...
            <li class="breadcrumb-item"><a href="{{route('users.list')}}">المستخدمين</a></li>
                <li class="breadcrumb-item active">تعديل ملف مستخدم
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput2" class="form-control" placeholder="مثال: علي محمد" name="name" value="{{$user->name}}"  required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="email" id="timesheetinput2" class="form-control" placeholder="مثال: name@company.com" name="email"  value="{{$user->email}}" required>
                                    <div class="form-control-position">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span style="color:red">*</span>
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput2" class="form-control" placeholder="مثال: ali123" name="username"  value="{{$user->username}}" required>
                                    <div class="form-control-position">
                                        <i class="la la-user"></i>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6"><div class="form-group">
                                    <label for="timesheetinput2">كلمة السر الجديدة</label>
                                    <div class="position-relative has-icon-left">
                                        <input type="password" id="timesheetinput2" class="form-control"   name="password">
                                        <div class="form-control-position">
                                            <i class="la la-envelope"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6"><div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="password" id="timesheetinput2" class="form-control"   name="password2">
                                        <div class="form-control-position">
                                            <i class="la la-envelope"></i>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <span style="color:red">*</span>
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput2" class="form-control" placeholder="مثال: 01123456789"  value="{{$user->mobile}}" name="mobile">
                                    <div class="form-control-position">
