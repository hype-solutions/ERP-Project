                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($user->role == 'مدير')
                                                            <button
                                                                class="btn btn-block btn-outline-warning btn-sm">{{ $user->role }}</button>
                                                        @elseif($user->role == 'محاسب')
                                                            <button
                                                                class="btn btn-block btn-outline-primary btn-sm">{{ $user->role }}</button>
                                                        @elseif($user->role == 'مسؤول مخازن')
                                                            <button
                                                                class="btn btn-block btn-outline-success btn-sm">{{ $user->role }}</button>
                                                        @elseif($user->role == 'مدير فروع')
                                                            <button
                                                                class="btn btn-block btn-outline-dark btn-sm">{{ $user->role }}</button>
                                                        @elseif($user->role == 'مسؤول مبيعات')
                                                            <button
                                                                class="btn btn-block btn-outline-danger btn-sm">{{ $user->role }}</button>
                                                        @endif
                                                    </td>
                                                    <td>
                                                            ...
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <div class="dropdown-menu" style="width: fit-content"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            ...
                                                                            الصلاحيات</a>
                                                                        <form
                                                                            action="{{ route('users.sendResetPassword') }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <input type="hidden"
                                                                ...
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                                        ...
                                                                        @if (isset($user->mobile))
                                                                            <a class="dropdown-item"
                                                                                href="tel:{{ $user->mobile }}">اتصال
                                                                                بالموبايل
                                                                            </a>
                                                                        @else
                                                                            <button class="dropdown-item" disabled>اتصال
                                                                                بالموبايل
                                                                                <small style="color: red">غير
                                                                                    مسجل</small></button>
                                                                        @endif

                                                                        <button class="dropdown-item" disabled>ارسال SMS
                                                                            <small style="color: red">غير
                                                                                متاحة</small></button>
                                                                        @if (isset($user->email))
                                                                            <a class="dropdown-item"
                                                                                href="mailto:{{ $user->email }}"> ارسال
                                                                                ايميل</a>
                                                                        @else
