                ...
                <div class="row">
                    <div class="col-12 col-sm-7">
                        ...
                        <div class="media mb-2">
                            <a class="mr-1" href="#">
                                <img src="{{ asset('theme/app-assets/images/custom/supplier.png') }}"
                                    alt="users view avatar" class="users-avatar-shadow rounded-circle" height="64"
                                    width="64">
                            </a>
                            <div class="media-body pt-25">
                                <h4 class="media-heading"><span class="users-view-name">{{ $supplier->supplier_name }}
                                    </span>
                                </h4>
                    ...
                    <div class="col-12 col-sm-5 px-0 d-flex justify-content-end align-items-center px-1 mb-2">
                        <div class="btn-group mr-1 mb-1">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <a class="dropdown-item" href="{{ route('suppliers.view', $supplier->id) }}">استعراض
                                    الملف</a>
                                <a class="dropdown-item" href="{{ route('suppliers.edit', $supplier->id) }}">تعديل
                                    الملف</a>
                                ...
                                <form action="{{ route('suppliers.delete', $supplier->id) }}" method="post"
                                    onsubmit="return confirm('هل أنت متأكد من حذف هذا المورد نهائيا و جميع تفاصيله من البرنامج')">
                                    @csrf
                                    @method('delete')
                        ...
                        <div class="btn-group mr-1 mb-1">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                @if (isset($supplier->supplier_mobile))
                                    <a class="dropdown-item" href="tel:{{ $supplier->supplier_mobile }}">اتصال
                                        بالموبايل</a>
                                @else
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>العنوان:</td>
                                                <td>
                                                    @if (isset($supplier->supplier_address))
                                            ...
                                            <tr>
                                                <td>الملاحظات:</td>
                                                <td>
                                                    @if (isset($supplier->supplier_notes))
                                ...
                                <div class="col-xl-6 col-lg-12 mb-1">
                                    <div class="form-group text-center">
                                        ...
                                        <button type="button" class="btn btn-float btn-outline-cyan"><i
                                                class="">{{ $countPurchases }}</i><span>عدد أوامر
                                                الشراء</span></button>
                                        <button type="button" class="btn btn-float btn-float-lg btn-outline-pink"><i
                                                class="">{{ $sumPurchases }} ج.م</i><span>إجمالي المبالغ من
                                                الشراء</span></button>
                                        <button type="button" class="btn btn-float btn-outline-cyan"><i
                                                class="">{{ $countProducts }}</i><span>عدد أصناف
                                                المورد</span></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-top-border no-hover-bg mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="active-tab32" data-toggle="tab"
                                                href="#active32" aria-controls="active32" aria-expanded="true">أصنفاف
                                                المورد</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="link-tab32" data-toggle="tab" href="#link32"
                                                aria-controls="link32" aria-expanded="false">المبالغ المستحقة</a>
                                        </li>
                                        <li class="nav-item">
                                                    ...
                                                    <tbody>
                                                        @foreach ($supplierInstallments as $item)
                                                            <tr>
                                                                <td>
                                                                    <div class="badge border-info info badge-border">
                                                                        <a href="#" target="_blank"
                                                                            style="color: #1e9ff2"><span>{{ $item->purchase_id }}</span></a>
                                                                ...
                                                                <td>
                                                                    @if ($item->paid == 'Yes')
                                                                        <button class="btn btn-primary">استعراض أمر
                                                                            الشراء</button>
                                                                        <button class="btn btn-info">استعراض فاتورة
                                                                            التسديد</button>
                                                                        <button class="btn btn-dark">طباعة فاتورة
                                                                            التسديد</button>
                                                                    @else
                                                                        <button class="btn btn-primary">استعراض أمر
                                                                            الشراء</button>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="badge border-warning warning badge-border">
                                                                        <a href="#" target="_blank"
                                                                            style="color: #ff9149"><span>{{ $purchase->id }}</span></a>
                                                                        <i class="la la-barcode font-medium-2"></i>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-success">استعراض أمر
                                                                        الشراء</button>
...
@section('pageJs')
    ...
    <script>
        initalizeDatatable('products','أصناف المورد \n {{ $supplier->supplier_name }}',5);
        initalizeDatatable('due','المبالغ المستحقة للمورد \n {{ $supplier->supplier_name }}',4);
        initalizeDatatable('purchases_orders','أوامر شراء المورد {{ $supplier->supplier_name }}',5);
    </script>
