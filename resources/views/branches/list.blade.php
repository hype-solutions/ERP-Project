...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">قائمة الفروع</h3>
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
          <a href="{{route('branches.add')}}" class="btn btn-outline-success block btn-lg" >
                إضافه فرع جديد
            </a>
...
@endif
    ...
    @if(session()->has('success'))
        @if(session()->get('success') == 'branch Deleted' )
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><li class="la la-home"></li>
                                {{ $branch->branch_name }}
                                @if(isset($branch->branch_address))
                                <br/>
                                <li class="la la-map"></li>
                                {{ $branch->branch_address }}
                                @endif
                            </td>
                            <td><li class="la la-mobile"></li> {{ $branch->branch_mobile }}</td>
                            ...
                            <td>
                                <a href="{{ route('branches.view', $branch->id) }}" class="btn btn-info btn-sm"><i class="la la-folder-open"></i> استعراض</a>
                                <a href="{{ route('branches.edit', $branch->id) }}" class="btn btn-primary btn-sm"><i class="la la-pencil-square-o"></i> تعديل</a>
                             </td>
                        </tr>
                        @endforeach
                     </tbody>
