<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="loading" data-textdirection="rtl" dir="rtl">
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{ gesture_asset('css/vendors-rtl.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ gesture_asset('css/bootstrap-extended.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ gesture_asset('css/colors.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ gesture_asset('css/components.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ gesture_asset('css/custom-rtl.css') }}">
...
@endif
    ...
    <!-- BEGIN: Vendor JS-->
        ...
        <script src="{{ gesture_asset('js/vendors.js') }}"></script>

    <!-- BEGIN Vendor JS-->

    @yield('pageJs')
    <script src="{{ gesture_asset('js/app-menu.js') }}"></script>
     <script src="{{ gesture_asset('js/app-min.js') }}"></script>
    <script src="{{ gesture_asset('js/footer.js') }}"></script>
    <script src="{{ gesture_asset('js/custom.js') }}"></script>
