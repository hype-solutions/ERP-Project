        ...
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <div class="row breadcrumbs-top">
            ...
            <li class="breadcrumb-item"><a href="{{route('reports.landing')}}">التقارير</a></li>
                <li class="breadcrumb-item active">تقارير المبيعات
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action="{{route('reports.sales.search')}}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>كاش</td>
                                            <td>{{$invoicesSumCash + $posSumCash}} ج.م</td>
                                        </tr>
                                        <tr>
                                            <td>فيزا</td>
                                            <td>{{$invoicesSumVisa}} ج.م</td>
                                        </tr>
                                        <tr>
                                            <td>اجل</td>
                                            <td>{{$invoicesSumLater}} ج.م</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-content">
                <div class="card-header"><h4>فواتير المبيعات</h4></div>
                <div class="card-body">
                    <!-- datatable start -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="badge badge-danger">
                                          <i class="la la-money font-medium-2"></i>
                                              <span>مدفوع {{$invoice->amount_collected}} ج.م فقط</span>
                                          </div>
                                        @endif</td>
                                    <td>
                                        <a href="{{route('invoices.view',$invoice->id)}}" class="btn btn-info btn-sm"><i class="la la-folder-open"></i> استعراض</a>
                                     </td>
                                </tr>
                                @endforeach
                             </tbody>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-content">
                <div class="card-header"><h4>البيع السريع</h4></div>
                <div class="card-body">
                    <!-- datatable start -->
                    <div class="table-responsive">
                        <table id="sessions" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('pos.receipt', $session->id) }}" target="_blank" class="btn btn-info btn-sm"><i class="la la-folder-open"></i> استعراض</a>
