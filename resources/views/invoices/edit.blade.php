                            ...
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="la la-flag"></i>تعديل فاتورة مبيعات رقم
                                                #{{ $invoice->id }}</h4>
                                            <div class="row">
                                                @if ($invoice->was_price_quotation)
                                                    <div class="col">
                                                        <span style="color: green"><i><u>(محولة من عرض سعر رقم
                                                                    {{ $invoice->price_quotation_id }})</u></i></span>
                                                    </div>
                                                @endif
                                                @if ($invoice->invoice_paper_num)
                                                    <div class="col">
                                                        <span style="color: green"><i><u>رقم الفاتورة الورقية:
                                                                    {{ $invoice->invoice_paper_num }}</u></i></span>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2-rtl form-control"
                                                            ...
                                                            <option value="{{ $invoice->branch_id }}">
                                                                {{ $invoice->branch->branch_name }}</option>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <textarea class="form-control" name="invoice_note" id="terms-conditions"
                                                rows="4">{{ $invoice->invoice_note }}</textarea>
                                        </fieldset>
                                                    ...
                                                    @foreach ($invoice->productsInInvoice as $key => $item)
                                                        <tr id="row_{{ $key + 1 }}">
                                                            <td>
                                                                <div class="form-group product_sel">
                                                                    <select class="select2-rtl form-control"
                                                                        ...
                                                                        onchange="return getProductInfo(this,{{ $key + 1 }})"
                                                                        required>
                                                            ...
                                                            <td><input type="text" class="product_input"
                                                                    ...
                                                                    value="{{ $item->product_desc }}" autocomplete="off" />
                                                            </td>
                                                            <td><input type="number" class="product_input"
                                                                    id="p_p_{{ $key + 1 }}"
                                                                    name="product[{{ $key + 1 }}][price]"
                                                                    value="{{ $item->product_price }}"
                                                                    onkeyup="return reCalculate({{ $key + 1 }})"
                                                                    onmouseup="return reCalculate({{ $key + 1 }})"
                                                                    min="0" autocomplete="off" />
                                                                <input type="hidden" name="product[1][cost]"
                                                                    id="p_c_{{ $key + 1 }}"
                                                            ...
                                                            <td><input type="number" class="product_input"
                                                                    ...
                                                                    onkeyup="return reCalculate({{ $key + 1 }})"
                                                                    onmouseup="return reCalculate({{ $key + 1 }})"
                                                                    min="0" autocomplete="off" /></td>
                                                            <td>
                                                                <span id="tot_{{ $key + 1 }}">0</span> ج.م
                                                            </td>
                                                            <td>
                                                                <center><button type="button" class="btn btn-danger btn-sm"
                                                                        onclick="return delRow({{ $key + 1 }})"
                                                                        style="vertical-align:center">X</button></center>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    <tr>
                                        ...
                                        <ul class="nav nav-tabs nav-top-border no-hover-bg">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="base-tab15" data-toggle="tab"
                                                    aria-controls="tab15" href="#tab15" aria-expanded="false">الفاتورة
                                                    الورقية</a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div class="col-md-4" id="dis_per">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="curr_per" class="form-control"
                                                                ...
                                                                max="100" onkeyup="return calculateDiscount(1)"
                                                                onmouseup="return calculateDiscount(1)" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4" style="display: none" id="dis_amount">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="curr_amount" class="form-control"
                                                                ...
                                                                onkeyup="return calculateDiscount(2)"
                                                                onmouseup="return calculateDiscount(2)" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="shipping_fees" class="form-control"
                                                                ...
                                                                onkeyup="return updateShipping()"
                                                                onmouseup="return updateShipping()" required
                                                                autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="tax_fees" class="form-control"
                                                                ...
                                                                value="{{ $invoice->invoice_tax }}"
                                                                onkeyup="return updateTax()" onmouseup="return updateTax()"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="" class="form-control" placeholder=""
                                                                name="invoice_paper_num"
                                                                value="{{ $invoice->invoice_paper_num }}"
                                                                autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if ($invoice->already_paid)
                                                        <h2 class="text-success"><span
                                                                class="la la-check-circle"></span>تم الدفع</h2>
                                                        <br>
                                                        @if ($invoice->payment_method != 'later')
                                                            <p><label>رقم إيصال الدفع: </label>
                                                                {{ $invoice->safe_transaction_id }}</p>
                                                            <p><label>الخزنة المدفوع بها: </label>
                                                                {{ $invoice->safe->safe_name }}</p>
                                                        @endif
                                                    @else
                                                        <h2 class="text-danger"><span
                                                                class="la la-exclamation-circle"></span>لم يتم الدفع</h2>
                                                    @endif
                                                </div>
                                                <input type="checkbox" name="already_paid" id="hasPaid"
                                                    style="display: none" @if ($invoice->already_paid) checked @endif>

                                                <div class="col-md-6" id="notPaid" @if ($invoice->already_paid) style="display: none" @else style="display: block" @endif>
                                                    <div class="form-group">
                                                        <select class="form-control" id="payment_method"
                                                            name="payment_method">
                                                            <option value="{{ $invoice->payment_method }}">تعديل طريقة
                                                                الدفع</option>
                                                    ...
                                                    @if ($invoice->payment_method != 'later')
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-dark"
                                                                onclick="return pay('{{ route('safes.receipt', $invoice->safe_transaction_id) }}');">استعراض
                                                                إيصال الدفع</button>
                                                            <input type="hidden" class="form-control"
                                                                name="safe_transaction_id"
                                                                value="{{ $invoice->safe_transaction_id }}" />
                                                        </div>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="div">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput3">اختر الخزنة التي سيتم الايداع
                                                                بها</label>
                                                            <select class="select2-rtl form-control"
                                                                ...
                                                                @if ($invoice->datesInInvoice->isEmpty())
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="form-group"
                                                                                style="display:none;" id="pay_now_1">
                                                                                <label for="projectinput3">خصم من:</label>
                                                                                <select class="select2-rtl form-control"
                                                                                    data-placeholder="الخزنة"
                                                                                    name="later[1][safe_id]" id="sel_xx_1">
                                                                                    <option></option>
                                                                                    @foreach ($invoice->allSafes() as $safe)
                                                                                        <option
                                                                                            value="{{ $safe->id }}">
                                                                            ...
                                                                            <td>
                                                                                @if ($item->paid != 'No')
                                                                                    <p class="text-success"> <input
                                                                                            ...
                                                                                            checked
                                                                                            onclick="return false;" /> تم
                                                                                        الدفع</p>
                                                                                    <p><label>رقم فاتورة الدفع: </label>
                                                                                        {{ $item->safe_payment_id }}</p>
