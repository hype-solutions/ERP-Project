    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
            href="{{ asset('theme/app-assets/css-rtl/bootstrap-extended.min.css') }}">
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('theme/app-assets/css-rtl/pages/invoices.min3.css') }}"
            id="printCss">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($currentProducts as $key => $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{ $product->product_price }} ج.م
                                                        </td>
                                                        <td class="text-right">{{ $product->product_qty }}</td>
                                                        <td class="text-right">
                                                            {{ $product->product_price * $product->product_qty }} ج.م
                                                        </td>
                                                    </tr>
                                                    <span
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-5 col-12">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <img src="{{ asset('theme/app-assets/images/pages/signature-scan.png') }}"
