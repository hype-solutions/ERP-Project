                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                onblur="return chooseCustomerType()" />
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                            ...
                                            <table class="table mb-0 table-bordered" id="myTable" style="overflow: hidden;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="hidden-row-1" style="display: none">
                                                        <td colspan="4" class="text-right"><strong> الخصم<span
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <textarea id="terms-conditions" class="form-control" name="quotation_note"
                                                rows="4"></textarea>
                                        </fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <button type="submit" id="saveBtn" class="btn btn-outline-primary btn-block"><i
...
@section('pageJs')
    ...
    <script>
        ...
        function updateTax() {
            ...
            currentInvoiceTotal = parseInt(currentInvoiceTotal) - parseInt(getDiscountAmount_1) - parseInt(getDiscountAmount_2);
