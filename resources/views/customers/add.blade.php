                            ...
                            <form class="form" method="post" action="{{ route('customers.adding') }}">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>
                                                    ...
                                                    <img src="{{ asset('theme/app-assets/images/custom/menu/4.png') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="timesheetinput2">
                                                    <span id="solo_text">اسم العميل</span>
                                                    <span id="com_text"  style="display: none">ممثل الشركة <small>[يمكن إضافة المزيد لاحقا]</small></span>
                                                </label>
                                                <span style="color:red">*</span>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        placeholder="مثال: علي محمد" name="customer_name" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="email" id="timesheetinput2" class="form-control"
                                                        placeholder="مثال: name@company.com" name="customer_email">
                                                    <div class="form-control-position">
                                    ...
                                    <div class="row" id="company_extra2" style="display: none">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        placeholder="الشركة التي يعمل لحسابها" name="customer_company">
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        placeholder="مثال: مدير المشتريات" name="customer_title">
                                                    <div class="form-control-position">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        placeholder="مثال: 01123456789" name="customer_mobile" required>
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        placeholder="مثال: 0223456789" name="customer_phone">
                                                    <div class="form-control-position">
                                    ...
                                    <div class="row" id="company_extra" style="display: none">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput2" class="form-control"
                                                        name="customer_commercial_registry">
                                                    <div class="form-control-position">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <textarea id="projectinput8" rows="3" class="form-control"
                                                name="customer_address"
                                                placeholder="عنوان الشخص أو عنوان الشركة إن وجد"></textarea>
                                            <div class="form-control-position">
                                                <i class="la la-map"></i>
                                            </div>
                                        </div>
