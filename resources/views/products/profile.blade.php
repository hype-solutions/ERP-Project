@extends('layouts.erp')
@section('title', 'ملف منتج - ' . $product->product_name)
                ...
                <div class="row">
                    <div class="col-12 col-sm-7">
                        ...
                        <div class="media mb-2">
                            <a class="mr-1" href="#">
                                <img src="{{ asset('theme/app-assets/images/custom/product.png') }}"
                                    alt="users view avatar" class="users-avatar-shadow rounded-circle" height="64"
                                    width="64">
                            </a>
                            <div class="media-body pt-25">
                                <h4 class="media-heading"><span class="users-view-name">{{ $product->product_name }}
                                    </span>
                                </h4>
                    ...
                    <div class="col-12 col-sm-5 px-0 d-flex justify-content-end align-items-center px-2 mb-2">
                        <div class="btn-group mr-1 mb-1">
                            <button type="button" class="btn btn-warning btn-sm dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">التحكم في المنتج</button>
                            <div class="dropdown-menu" x-placement="bottom-start"
                                style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                <a class="dropdown-item" href="{{ route('products.view', $product->id) }}">استعراض
                                    المنتج</a>
                                <a class="dropdown-item" href="{{ route('products.edit', $product->id) }}">تعديل
                                    المنتج</a>
                                ...
                                <form action="{{ route('products.delete', $product->id) }}" method="post"
                                    onsubmit="return confirm('هل أنت متأكد من حذف هذا المنتج نهائيا و جميع تفاصيله من البرنامج')">
                                    @csrf
                                    @method('delete')
                        ...
                        <div class="btn-group mr-1 mb-1" style="width: 100%;">
                            <button type="button" class="btn btn-info btn-sm btn-min-width dropdown-toggle"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> التحكم في
                                المخزون</button>
                            <div class="dropdown-menu" x-placement="bottom-start"
                                style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> تتبع المخزون:</td>
                                                <td>
                                                    @if ($product->product_track_stock == 1)
                                                        نعم (تنبيه عند الوصل الى
                                                        {{ $product->product_low_stock_thershold }} قطع)
                                                    @else
                                                        لا
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($product->product_notes))
                                ...
                                <div class="col-xl-6 col-lg-12 mb-1">
                                    <div class="form-group text-center">
                                        ...
                                        <button type="button" class="btn btn-float btn-outline-cyan"><i
                                                class="">{{ $productCost + 0 }} ج.م</i><span>متوسط سعر
                                                التكلفة</span></button>
                                        <button type="button" class="btn btn-float btn-float-lg btn-outline-pink"><i
                                                class="">{{ $product->product_total_out }}</i><span>إجمالي
                                                القطع المباعة</span></button>
                                        <button type="button" class="btn btn-float btn-outline-cyan"><i
                                                class="">{{ $product->product_total_in - $product->product_total_out }}</i><span>كمية
                                                المخزون</span></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                                    ...
                                    <ul class="nav nav-tabs nav-top-border no-hover-bg mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="active-tab32" data-toggle="tab" href="#active32"
                                                aria-controls="active32" aria-expanded="true">رصيد الفروع</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="link-tab32" data-toggle="tab" href="#link32"
                                                aria-controls="link32" aria-expanded="false">الموردين</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <a class="nav-link" id="link-tab34" data-toggle="tab" href="#link34" aria-controls="link34" aria-expanded="false">الكميات المضافة يدويا</a>
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="badge border-info info badge-border">
                                                                        <a href="{{ route('branches.view', $branch->branch->id) }}"
                                                                            target="_blank"
                                                                            style="color: #1e9ff2"><span>{{ $branch->branch->id }}</span></a>
                                                                    </div>
                                                                </td>
                                                                <td><a href="{{ route('branches.view', $branch->branch->id) }}"
                                                                        target="_blank">{{ $branch->branch->branch_name }}</a>
                                                                </td>
                                                    ...
                                                    <tbody>
                                                        @foreach ($supplierProducts as $item)
                                                            <tr>
                                                                <td>
                                                                    <div class="badge border-info info badge-border">
                                                                        <a href="{{ route('suppliers.view', $item->supplier->id) }}"
                                                                            target="_blank"
                                                                            style="color: #1e9ff2"><span>{{ $item->supplier->id }}</span></a>
                                                                    </div>
                                                                </td>
                                                                <td><a href="{{ route('suppliers.view', $item->supplier->id) }}"
                                                                        target="_blank">{{ $item->supplier->supplier_name }}</a>
                                                                </td>
                                                                <td>{{ $item->quantity }}</td>
                                                                <td>{{ $item->counttimes }}</td>
                                                                <td><span style="color : rgb(35, 145, 45)">أقل سعر:
                                                                    </span>{{ $item->minprice }} ج.م</td>
                                                                <td><span style="color: crimson;white-space: pre-line">أعلى
                                                                        سعر: </span>{{ $item->maxprice }} ج.م</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="tab-pane" id="link33" role="tabpanel" aria-labelledby="link-tab33"
                                            aria-expanded="false">
                                            <div class="table-responsive">
                                                                    ...
                                                                    <td>
                                                                        @if (isset($transfer->branchTo))
                                                                            ...
                                                                            <div class="badge badge-warning">
                                                                                <i
                                                                                    class="la la-arrow-left font-medium-2"></i>
                        ...
                        <table class="table mb-0" id="manual_add">
                            ...
                            <tbody>
                              ...
                              @endforeach
                                                    ...
                                                    <tbody>
                                                        @foreach ($productPurchasesOrders as $purchase)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($purchase->purchase->already_paid > 0)
                                                                        <div class="badge badge-success">
                                                                ...
                                                                <td>
                                                                    @if ($purchase->purchase->already_delivered > 0)
                                                                        <div class="badge badge-success">
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('purchasesorders.view', $purchase->purchase->id) }}"
                                                                        class="btn btn-success">استعراض أمر الشراء</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                        ...
                                        <div class="tab-pane" id="link36" role="tabpanel"
                                            aria-labelledby="link-tab36" aria-expanded="false">
                                            <div class="table-responsive">
