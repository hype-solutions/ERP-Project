              ...
              <form class="form" method="post" action="{{route('products.adding')}}">
                ...
                <div class="form-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput2" class="form-control" name="product_name" required>
                            ...
                            @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="timesheetinput2" class="form-control" placeholder="مثال: بفاريا" name="product_brand">
                                            <div class="form-control-position">
                    ...
                    <div class="row" >
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                <textarea id="projectinput8" rows="3" class="form-control" name="product_desc"></textarea>
                                <div class="form-control-position">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group pb-1">
                                ...
                                <input type="checkbox" id="switcherySize10" name="product_track_stock" class="switchery" value="1" data-size="lg" checked />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="notify" class="form-control"  name="product_low_stock_thershold">
                                    <div class="form-control-position">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-left">
                        <textarea id="projectinput8" rows="3" class="form-control" name="product_notes"></textarea>
                        <div class="form-control-position">
