                    ...
                    <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                            <div class="card-header border-0 pb-0">
                                ...
                                <div class="row">
                                    <div class="col-12 mt-1 text-center">
                                        <p>برنامج <code>Geture ERP</code> لإدارة الشركات
                                    </div>
                                </div>
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>تثبيت
                                        و تشغيل البرنامج</span></h6>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" id="verificationForm">
                                        ...
                                        <button type="button" onclick="return verify()"
                                            class="btn btn-outline-info btn-lg btn-block">
                                            <span id="btnText"><i class="ft-unlock"></i> تشغيل البرنامج</span>
                                            <span id="loading" style="display: none"><i class="la la-spinner spinner"></i>
                                                جاري التحقق</span>
                                        </button>

                                    </form>
                                    <h3 class="text-success text-center" id="verified" style="display: none">تم التحقق</h3>
                                    <h3 class="text-danger text-center" id="notVerified" style="display: none">كود خطأ, حاول
                                        مرة أخرى</h3>
                                    <h4 class="text-warning text-center" id="alreadyInstalled" style="display: none">
                                        ...
                                        <br />
                                        <a href="https://gesture-sys.com" target="_blank" class="card-link">تواصل
                                            معنا</a>
                                    </h4>
                                    <h3 class="text-danger text-center" id="tooManyAttempts" style="display: none">محاولات
                                        كثيرة خاطئة, برجاء المحاولة لاحقا</h3>
                            ...
                            <div class="card-footer border-0">
                                <form id="continue" style="display: none" action="{{ route('config.install.step2') }}"
                                    method="post">
                                    @csrf
                                ...
                                <p class="float-sm-left text-center" id="newClient">عميل جديد؟ <a
                                        href="https://gesture-sys.com" target="_blank" class="card-link">تواصل معنا</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    success: function(data) {
                        ...
                        if (data.verfied == 1) {
                            ...
                            if (data.alreadyInstalled == 1) {
                                ...
                                var renewOrNot = '';
                                if (data.online == 1) {
                                    renewOrNot = '<tr><th>تاريخ التجديد القادم</th><td>' + data.nextRenewal +
                                        '</td></tr>'
                                }
                                $("#ownerData").html('<table class="table"><tr><th>اسم المالك</th><td>' + data
                                    .owner + '</td></tr><tr><th>تاريخ الشراء</th><td>' + data.purchaseDate +
                                    '</td></tr>' + renewOrNot + '</table>');
                                $("#continue").show();
