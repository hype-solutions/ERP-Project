...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">قائمة بنود الدواخل</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}">البرنامج</a></li>
            <li class="breadcrumb-item"><a href="{{route('ins.list')}}">الدواخل</a></li>
                <li class="breadcrumb-item active">استعراض بنود الدواخل
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form" method="post" action="{{route('ins.categories.adding')}}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
