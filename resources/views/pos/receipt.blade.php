...
<body onload="window.print()">
    ...
    <table border="1" width="95%">
        @if ($currentSession->discount_percentage || $currentSession->discount_amount)
            <tr>
        ...
        @endif
        @if ($currentSession->discount_percentage)
            <tr>
        ...
        @endif
        @if ($currentSession->discount_amount)
            <tr>
                <td align='center'><b>الخصم</b></td>
                <td align='center'><b>
                        <font color='red'>{{ $currentSession->discount_amount }}</font>
                    </b></td>
                <td align='center'><b>جنية</b></td>
            </tr>
        @endif
