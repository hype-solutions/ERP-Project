@extends('layouts.erp')
@section('title', 'قائمة دفعات أمر شراء رقم #'.$po)
        ...
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <div class="row breadcrumbs-top">
            ...
            <li class="breadcrumb-item"><a href="{{route('reports.landing')}}">الأقساط</a></li>
                <li class="breadcrumb-item active">قائمة دفعات أمر شراء رقم # {{$po}}
                </li>
              </ol>
            </div>
          </div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-content">
                <div class="card-header"><h4>قائمة دفعات أمر شراء رقم # {{$po}}</h4></div>
                <div class="card-body">
                    <!-- datatable start -->
                    <div class="table-responsive">
                        <table id="po" class="table">
                            ...
                            <tbody>
                                ...
                                @if($item->paid == 'Yes')
                                <tr style="background-color: #cff1cf">
                                @else
                                <tr>
                                @endif
                                    ...
                                    <td>
                                        @if($item->paid == 'Yes')
                                            <h4>مدفوع بتاريخ {{$item->date_collected}}</h4>

                                                <button class="btn btn-success btn-sm" onclick="return pay('{{route('safes.receipt',$item->safe_payment_id)}}');">إيصال الدفع</button>
